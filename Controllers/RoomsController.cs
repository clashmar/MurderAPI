...
namespace MurderAPI.Controllers
{
    ...
    public class RoomsController : ControllerBase
    {
        ...
        {
            if (password == null || password!.ToLower() != "bastet") return Unauthorized("At the bottom of the stairs you see an imposing brass door sealed with an in-built, six-character alphabetical lock. Above the combination lock is an embossed relief of a regal looking cat.");
